...
**Current focus:** AkkaraDB (C++ LSM-tree database with audit log and time-travel query), Minecraft cheat client + anti-cheat research cycle, custom infrastructure (GIGABYTE G5 w/ NXRM + Nginx)

## Active Work

- **[SwiftStorm Studio](https://github.com/SwiftStorm-Studio)** — Development collective  
- **[Fabricord](https://github.com/ririf4/Fabricord)** — Fabric mod for Discord integration (DiscordSRV-like)  
...
- **Server Infrastructure** — PCIe 4.0 4TB SSD migration, NXRM relocate to external NVMe enclosure  
...
- **Docs:** [docs.ririfa.net](https://docs.ririfa.net)  
- **Modrinth:** [RiriFa](https://modrinth.com/user/RiriFa)  
- **Discord:** ririf4  
